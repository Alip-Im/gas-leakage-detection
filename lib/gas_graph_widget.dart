...
class _RealtimePpmChartState extends State<RealtimePpmChart> {
  ...
  void didUpdateWidget(covariant RealtimePpmChart oldWidget) {
    ...
    // Masukkan titik baharu setiap kali data PPM di Firebase berubah
  ...
  void _addPoint(int ppm) {
    setState(() {
      ...
      // Buang titik paling lama jika melebihi 10 data
            ...
            SizedBox(
              ...
              child: LineChart(
                LineChartData(
                  ...
                  // Buat garis penanda merah untuk threshold_limit
                    ...
                    horizontalLines: [
                      HorizontalLine(
                        ...
                        label: HorizontalLineLabel(
                          ...
                          labelResolver: (line) => 'Limit (${widget.threshold})',
                        ),
                      ),
                    ],
                  ),
                  lineBarsData: [
                    LineChartBarData(
                      spots: _ppmSpots,
                      isCurved: true,
                      color: widget.currentPpm >= widget.threshold ? Colors.red : Colors.indigo,
                      barWidth: 3,
                      isStrokeCapRound: true,
                      dotData: const FlDotData(show: true),
                      belowBarData: BarAreaData(
                        show: true,
                        color: (widget.currentPpm >= widget.threshold ? Colors.red : Colors.indigo).withOpacity(0.15),
                      ),
                    ),
                  ],
                ),
